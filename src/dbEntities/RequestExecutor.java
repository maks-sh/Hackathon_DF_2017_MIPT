...
public interface RequestExecutor {
	 ...
	 * @param cn connection to work with
	 * @param sqlRequest request to execute
	 * @return JTable with the results
	 * @throws ClassNotFoundException if smth goes wrong
	 * @throws SQLException if smth goes wrong with SQL part
	 */
	public default JTable getResultAsTable(Connection cn,String sqlRequest) throws ClassNotFoundException, SQLException {
		String[] columnNames;
        Object[][] data;
	 ...
	 */
	public default ResultSet executeRequest(Connection cn, String sqlRequest) throws SQLException,ClassNotFoundException{
